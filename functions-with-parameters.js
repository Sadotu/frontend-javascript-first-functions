...
const seconds = minutesToSeconds(34);
console.log(seconds);
...
const ageDog = calculateDogYears(3);
console.log(ageDog);
...
const personalDetails = createDetailString("Nick", "de Kok", "Web Developer");
